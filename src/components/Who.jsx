  ...
  return (
    <section id="who" className="reveal relative -z-50 py-20 px-6">
      <div className="max-w-6xl mx-auto rounded-3xl bg-gradient-to-tr from-white/3 to-white/2 backdrop-blur-xl border border-white/6 p-10">
        <h2 className="text-2xl font-semibold">Who is Seradox for?</h2>
        <p className="mt-4 text-gray-300 max-w-3xl">
          Seradox is built for developers, startups, agencies, and product teams who:
        </p>
        ...
        <div className="mt-6 grid md:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-white/6 border border-white/6">
            ...
            <p className="text-sm text-gray-300 mt-2">Use Seradox as opinionated infra for faster provisioning and cost control.</p>
          </div>
        </div>
      </div>
    </section>
