      ...
      <div className="relative z-10 max-w-6xl w-full flex flex-col lg:flex-row items-start gap-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start gap-6">
            <div className="flex-1">
              <h1 className="text-3xl md:text-4xl font-bold leading-tight">
                Outsourced <span className="text-[#c900ff]">VM Orchestration</span> Team
              </h1>
              ...
              <div className="mt-6 flex gap-4">
                <button className="px-5 py-2 rounded-full  transition font-medium shadow-[0_10px_40px_rgba(0,0,0,0.6)]">
                  Start Free Trial
                </button>
              ...
              <div className="mt-6 flex items-center gap-4">
                <div className="text-xs text-gray-300">
                  Trusted by teams at early startups and agencies for fast infra delivery.
                </div>
              </div>
            </div>
            ...
            <aside className="w-full lg:w-[260px]  rounded-2xl backdrop-blur-xl shadow-[0_5px_10px_rgba(0,0,0,0.6)]">
              <div className="rounded-2xl p-4">
                <p className="text-sm text-gray-200">“A joy to use — we launched our MVP in days, fully secure and autoscaled.”</p>
                <div className="mt-4 flex items-center gap-2">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-[#c900ff] to-[#7a00ff] flex items-center justify-center text-sm font-bold">S</div>
                  <div className="text-xs text-gray-300">CEO • Startup</div>
                </div>
              </div>
            </aside>
          </div>
        ...
        <div className="lg:w-1/3 w-full flex flex-col gap-4">
          <div className="lg:backdrop-blur-[10px] backdrop-blur-[2px]  rounded-xl p-8 shadow-[0_10px_40px_rgba(0,0,0,0.6)] px-4 py-3">
            <h3 className="text-sm text-gray-200 font-medium">About our team</h3>
            <p className="text-xs text-gray-300 mt-2">Remote-first devops & cloud engineering team built to deliver production VM orchestration & infra automation.</p>
          </div>

          <div className="grid grid-cols-1 gap-3">
            <div className="lg:backdrop-blur-[10px] backdrop-blur-[2px]  rounded-xl p-8 shadow-[0_10px_40px_rgba(0,0,0,0.6)] px-4 py-3">
              <h4 className="font-semibold">Smart development</h4>
              <p className="text-xs text-gray-300 mt-1">Infra-as-code, security defaults, fast developer onboarding.</p>
            </div>
            <div className="lg:backdrop-blur-[10px] backdrop-blur-[2px]  rounded-xl p-8 shadow-[0_10px_40px_rgba(0,0,0,0.6)] px-4 py-3">
              <h4 className="font-semibold">Super-fast delivery</h4>
              <p className="text-xs text-gray-300 mt-1">MVPs in weeks; production-ready setups out of the box.</p>
            </div>
            <div className="lg:backdrop-blur-[10px] backdrop-blur-[2px]  rounded-xl p-8 shadow-[0_10px_40px_rgba(0,0,0,0.6)] px-4 py-3">
              <h4 className="font-semibold">Global & synced</h4>
              <p className="text-xs text-gray-300 mt-1">Multi-region support and team permission management.</p>
            </div>
          </div>
        </div>
      </div>
