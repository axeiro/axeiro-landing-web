...
export default function NavbarWrapper() {
  return (
    ...
    >
      <nav className="pointer-events-auto w-full sm:max-w-6xl mx-2 sm:mx-4 rounded-full backdrop-blur-xs border border-white/8 px-2 sm:px-6 py-2 sm:py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
             <div className={`text-2xl tracking-wide ${poppins400.className}`}>
            axeiro
          </div>
          <div className="hidden lg:flex gap-6 text-sm text-gray-200">
